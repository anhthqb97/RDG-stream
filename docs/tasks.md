...
| **Requirements** | [tasks/requirements.md](./tasks/requirements.md) |
...
| 9 — Validation | [tasks/phase-9-validation.md](./tasks/phase-9-validation.md) | TASK-053 – 059 | Not started |
| 10 — Production | [tasks/phase-10-production.md](./tasks/phase-10-production.md) | TASK-060 – 065 | Not started |

**MVP path (implementation):** Phase 0 → 2 → 3 + 5 → 4 → 6 → 9
